...
const worksData = [
    ...
    {
    title: "Second-Brain",
    description: "A Second Brain application is a digital knowledge management system designed to capture, organize, and retrieve information efficiently. It enhances thinking, creativity, and productivity, while also enabling seamless sharing of content and links with others.",
    projectLink: "https://github.com/Anubhav88s/secondBrain",
    codeLink: "https://github.com/Anubhav88s/secondBrain",
    imgUrl: images.secondBrain,
    tags: ["React.js"],
  },
    {
    title: "Portfolio",
